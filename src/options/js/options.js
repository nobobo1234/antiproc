...
var unique = function unique(array) {
    return [].concat(_toConsumableArray(new Set(array))).filter(function (e) {
        return e !== "";
    });
                ...
                case 2:
                    ...
                    if (times.times) {
                        $('.days').each(function (i, e) {
                            ...
                            if (!day.on) $(e).find('.timepicker').prop('disabled', true);
                            if (day.time) {
                ...
                case 30:
                    ...
                    */
                                ...
                                while (1) {
                                    switch (_context2.prev = _context2.next) {
                                        case 0:
                                            ...
                                            $('#active-days').find('.days').each(function (i, e) {
                                                var day = constants.times.find(function (ce) {
                                                    return $(e).find('p').text().toLowerCase() === ce.day;
                                                });
                                                day.on = $(e).find('.day-checkbox').is(':checked');
                                                if ($(e).find('.timepicker').eq(0).val() !== "" && $(e).find('.timepicker').eq(1).val() !== "") {
                                                    var timepickers = [$(e).find('.timepicker').eq(0), $(e).find('.timepicker').eq(1)];
                                                    var timeOne = moment(timepickers[0].val(), 'HH:mm');
                                                    var timeTwo = moment(timepickers[1].val(), 'HH:mm');
                    ...
                    $('.day-checkbox').change(function () {
                        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(checkbox) {
                            var parent, _times, _times2, _parent;

                            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                while (1) {
                                    switch (_context3.prev = _context3.next) {
                                        case 0:
                                            parent = $(checkbox.target).parent().parent().parent();
                                            ...
                                            parent.find('.timepicker').each(function (i, e) {
                                            ...
                                            _context3.next = 7;
                                            return storage.set({ times: _times });
                                        ...
                                        case 9:
                                            //if unchecked, make all inputs disabled
                                            _times2 = [];
                                            _parent = $(checkbox.target).parent().parent().parent();

                                            _parent.find('.timepicker').each(function (i, e) {
                                            ...
                                            _context3.next = 15;
                                            return storage.set({ times: _times2 });
                                ...
                                return regeneratorRuntime.wrap(function _callee5$(_context5) {
                                    while (1) {
                                        switch (_context5.prev = _context5.next) {
                                            ...
                                            case 2:
                                                data = _context5.sent;
                                                i = data.sites.indexOf($(event.currentTarget).parent().text());
...
module.exports = function () {
    ...
    _createClass(_class, [{
        ...
        key: "remove",
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(string) {
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return this.storage.remove(string);
